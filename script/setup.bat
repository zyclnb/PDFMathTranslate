...
set APP_DIR=%REPO_ROOT%\pdf2zh_dist
set APP_PORT=7860
...
pip install --no-warn-script-location --upgrade "%REPO_ROOT%" -i !PIP_MIRROR! || goto :error
...
) > "%APP_DIR%\start_pdf2zh.bat"

echo.
echo Setup complete.
echo Run "%APP_DIR%\start_pdf2zh.bat" to launch PDFMathTranslate.
echo.
